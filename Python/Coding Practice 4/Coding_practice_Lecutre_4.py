   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "---------------------------------------------------------------\n",
      "\n",
      "Apologies!! MS Dhoni we are not able to acccomodate you.\n",
      "\n",
      "Apologies!! Alexis Rose we are not able to acccomodate you.\n",
      "\n",
      "Apologies!! Steven Smith we are not able to acccomodate you.\n",
      "\n",
      "Apologies!! Ellse Perry we are not able to acccomodate you.\n"
     ]
    }
   ],
   "source": [
